...
/**
 * The type Gestor diccionario tecnico.
 */
public class GestorDiccionarioTecnico {


    /**
     * Instantiates a new Gestor diccionario tecnico.
     */
    public GestorDiccionarioTecnico() {
    }

    /**
     * Obtener palabras tecnicas list.
     *
     * @return the list
     */
...
//        return data.getPalabrasTecnicas().toString();
    ...
    /**
     * Registrar palabra tecnica string.
     *
...
//        data.agregarPalabraTecnica(new PalabraTecnica(palabra, categoria));
    ...
    /**
     * Eliminar palabra tecnica string.
     *
     * @param palabra the palabra
     * @return the string
     */
    ...
    /**
     * Modificar palabra tecnica string.
     *
